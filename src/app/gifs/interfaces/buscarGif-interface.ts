// To parse this data:
//
//   import { Convert, BuscarGIF } from "./file";
//
//   const buscarGIF = Convert.toBuscarGIF(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface BuscarGIF {
  data:       Gif[];
...
export class Convert {
  public static toBuscarGIF(json: string): BuscarGIF {
      return cast(JSON.parse(json), r("BuscarGIF"));
  }

  public static buscarGIFToJson(value: BuscarGIF): string {
      return JSON.stringify(uncast(value, r("BuscarGIF")), null, 2);
  }
}
